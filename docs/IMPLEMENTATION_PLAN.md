...
- Provider-gated verification delivery with no plaintext code in API responses or browser UI, HTTPS enforcement in production, and fail-closed issuance when the delivery gateway is absent.
