...
| Administration                  | Code-complete      | Branch, fleet, documents, policy publication, bilingual public-content publishing, staff/access, reviews, audit, and operations are implemented; owner approval and provider operations remain external.                                                                                                                                                          |
